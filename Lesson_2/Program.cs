...
long num; // для любителей огромных цифр. unsigned уже перебор
bool isnum = long.TryParse(number, out num); // пробуем вхождение значение number в целочисленные значения, есть ли в веденной строке цифры
